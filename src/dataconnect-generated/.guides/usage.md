...
```ts
import { useAddMovieToList, useGetPublicLists, useCreateReview, useGetMoviesByGenre } from '@dataconnect/generated/react';
...
```js
import { addMovieToList, getPublicLists, createReview, getMoviesByGenre } from '@dataconnect/generated';
